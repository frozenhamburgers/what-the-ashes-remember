...
// smears into streaks. See include/nuclear/bomb_block/impact.glsl for the whole pipeline.
//
// Writes coverage in .r. Runs at half resolution (nuclear_impact in
// NuclearDetonationPostProcessor#getScaledTargets) - the radial blur destroys most of the
