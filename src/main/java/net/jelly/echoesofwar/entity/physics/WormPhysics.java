...
/**
 * Shared force-resolution math for anything sliding along terrain. Given a velocity, an external
 * force, gravity, and a sampled ground normal, applies gravity, projects out the into-the-ground
 * component against the surface normal, and applies friction.
 */
