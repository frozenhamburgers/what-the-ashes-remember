...
public class ApophisRenderState extends LivingEntityRenderState implements MarionetteModel.MarionetteRenderState {
    public Vec3[] partDirections = new Vec3[0];
    public Vec3[] partOffsets = new Vec3[0];
    /** per-segment girth, so the tail can taper - see ApophisModel#setupAnim */
    public float[] partScales = new float[0];
