...
public class TalosBoxGeoModel extends GeoModel<TalosBoxBlockEntity> {
    private static final Identifier MODEL = Identifier.fromNamespaceAndPath(EchoesofWar.MODID, "block/pandoras_box");
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(EchoesofWar.MODID, "textures/block/talos_pandoras_box.png");
    ...
    @Override
    public Identifier getAnimationResource(TalosBoxBlockEntity animatable) {
        return ANIMATIONS;
    }

    @Override
    public Identifier[] getAnimationResourceFallbacks(TalosBoxBlockEntity animatable) {
